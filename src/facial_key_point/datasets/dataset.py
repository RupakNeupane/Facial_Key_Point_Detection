...
class FaceKeyPointData(Dataset):
    def __init__(self, csv_path='/home/ubuntu/Facial_key_point/data/training_frames_keypoints.csv', split='training', device=torch.device('cpu'),model_input_size = 224):
